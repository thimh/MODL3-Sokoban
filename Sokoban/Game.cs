...
namespace Sokoban
{
    class Game
    {
        ...
        public Level LoadLevel2(int levelNumber)
        {
            ...
            string text = System.IO.File.ReadAllText(@"C:\Users\Victor\Desktop\Huiswerk\Blok 5\MODL3\Sokoban\Sokoban\doolhof" + levelNumber + ".txt");
            string[] lines = System.IO.File.ReadAllLines(@"C:\Users\Victor\Desktop\Huiswerk\Blok 5\MODL3\Sokoban\Sokoban\doolhof" + levelNumber + ".txt");
